<div class="flex space-x-1 justify-around">
   ...
   // $url =  url("/items/checklist/{$client_id}");
    ...
    {{--<a href="#"  data-toggle="modal" data-target="#" class="btn btn-primary btn-sm">Sold</a>--}}


    @if(isset($show_sold_section))
        @livewire('property.item-checklist.property-house-sold-component',['property_id' =>'11'])
    @endif
            ...
            {{--<div class="modal-dialog" role="document">--}}
                {{--<div class="modal-content">--}}
                    ...
                    {{--<div class="modal-footer">--}}
                        {{--<button type="button" class="btn btn-primary" wire:click="$emit('update_property_status')" id="property-update">Save changes</button>--}}
