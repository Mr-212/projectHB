<div class="flex space-x-1 justify-around">
    ...
    <a href="{{url("/portfolio/{$property_id}")}}" class="p-1 text-blue-600 hover:bg-blue-600 hover:text-white rounded">
    ...
    @role('Super Admin')
    @livewire('component.client-property-checklist-log-component',['property_id'=>$property_id],key($property_id))    @endrole



    {{--@if(isset($property_status_id) && $property_status_id == PropertyStatusConstant::HOUSE_VACANT)--}}
        {{--@livewire('property.item-checklist.property-house-sold-component',['client_id' =>''])--}}
    {{--@endif--}}
