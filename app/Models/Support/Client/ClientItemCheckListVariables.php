...
//            'pre_closing.driver_license_applicant_checked' => 'accepted_if_not_null:client.co_applicant_email',
            'pre_closing.driver_license_applicant_checked' => 'required_with:client.co_applicant_email|in:1,yes',
//
//            'pre_closing.driver_license_applicant_checked' => [new AcceptedWithCondition('client.co_applicant_email',null)],
            ...
            'pre_closing.driver_license_co_applicant_checked' => 'required_with:client.co_applicant_email|in:1,yes',
            'pre_closing.driver_license_co_applicant_checked_at' => '',
            'pre_closing.driver_license_co_applicant_checked_by' => '',

            'pre_closing.soc_sec_card_applicant_checked' => 'required_with:client.co_applicant_email|in:1,yes',
            'pre_closing.soc_sec_card_applicant_checked_at' => '',
            'pre_closing.soc_sec_card_applicant_checked_by' => '',

            'pre_closing.soc_sec_card_co_applicant_checked' => 'required_with:client.co_applicant_email|in:1,yes',
    ...
    public static function getValidationRulesForBeforeClosing(){
        ...
        return [
            ...
            "pre_closing.inspection_checked" =>'accepted',
            "pre_closing.inspection_checked_at" =>'',
            "pre_closing.inspection_checked_by" =>'',
