...
(function (global, factory) {
    ...
    // substring from most specific to least, but move to the next array client if it's a more specific variant than the current root
        ...
        while (i < names.length) {
            ...
            while (j > 0) {
                ...
                if (next && next.length >= j && compareArrays(split, next, true) >= j - 1) {
                    //the next array client is better than a shallower substring of this one
                    break;
                }
                j--;
            }
